...
## Conclusions
- The final model used the Augmentor library to artificially generate enough samples to come up with a model that can detect a correct cancer type with a validation accuracy around 77%. 
...
## Contact
Created by [@vasanth-gummadala] - feel free to contact me!